...
void CFWSetup::on_btnDetectCFW_clicked()
{
    ...
    {
        QMessageBox::information(this, tr("Info"), tr("CFW is disconnected or is being initialized!\n(Note:Part of the camera model has no detect CFW function.)"), QMessageBox::Ok);
    }
}
