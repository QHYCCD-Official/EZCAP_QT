...
public:
    ...
    int FITRead_Common(QString filename, uint32_t *ImgW, uint32_t *ImgH, uint32_t *ImgB, uint32_t *ImgC, uint8_t *ImgData);
    ...
    void FITwrite_Live(QString filename, int ImageWidth, int ImageHeight, int ImageBpp, int ImageChannel, unsigned char *Buf);
