...
#define MyAppName "QHYCCD EZCAP_QT(64 bits)"
...
[Setup]
AppId={{FC94FB89-ED78-4061-89CD-58890F3E6AD7}
...
VersionInfoDescription=EZCAP_QT(64 bits)
VersionInfoVersion={#MyAppVersion}
VersionInfoTextVersion=08
DefaultDirName={pf64}\QHYCCD\EZCAP_QT(64 bits)
DefaultGroupName = QHYCCD EZCAP_QT(64 bits)
OutputDir=Output
OutputBaseFilename= EZCAP_QT_V{#MyAppVersion}_Setup_64bits
...
[Icons]
Name: "{group}\EZCAP_QT(64 bits)";                                Filename: "{app}\EZCAP_Qt\EZCAP.exe"
Name: "{group}\Uninstall EZCAP_QT(64 bits)";                      Filename: "{uninstallexe}"
Name: "{commondesktop}\EZCAP_QT(64 bits)";                        Filename: "{app}\EZCAP_Qt\EZCAP.exe"; WorkingDir: "{app}\EZCAP_Qt"
